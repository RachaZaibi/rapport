    ...
    \begin{itemize}
        \item \textbf{Python} :
            \begin{itemize}
                ...
                \item Rôle : Utilisé pour le traitement des données, la collecte via API/HL7, et l'intégration des bibliothèques de vision par ordinateur (OpenCV, Tesseract OCR).
