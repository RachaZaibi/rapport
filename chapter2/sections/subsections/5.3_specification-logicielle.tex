...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Python} : Pour le traitement des données, l’intégration OCR (OpenCV, Tesseract), et la communication via API/HL7.
    \end{itemize}
    ...
    \end{itemize} \item \textbf{Base de données} :
    \begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{HL7} : Pour l’échange de données avec les moniteurs Mindray.
    ...
    \end{itemize}
\end{itemize}
% Optional: Add a diagram here
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{chapter2/sections/diagrams/architecture.png} % Replace with your diagram file
