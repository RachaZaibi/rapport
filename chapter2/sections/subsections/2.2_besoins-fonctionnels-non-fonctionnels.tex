...
\begin{itemize}
    \item \textbf{Collecte des données} : Le système doit être capable de collecter des données en temps réel à partir des moniteurs de signes vitaux et des caméras OCR.
