...
\begin{enumerate}
    ...
    \begin{itemize}
<<<<<<< HEAD
        \item Les données sont collectées à partir des moniteurs Mindray via des interfaces réseau ou des API propriétaires.
        \item Les données des machines anciennes sont capturées via des caméras et traitées pour extraire les valeurs vitales à l'aide de l'OCR.
=======
...
>>>>>>> a485d22827129f93ec9986d45273b7e0e7f02d91
    \end{itemize}
