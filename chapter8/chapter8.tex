...
Le projet \textit{GMAO} a permis de concevoir et de développer un prototype innovant pour la gestion centralisée de la maintenance informatique et des équipements, répondant aux besoins spécifiques des organisations tunisiennes. Grâce à une approche agile (Scrum) et à l'intégration de technologies telles que l'automatisation des workflows, les codes QR pour le suivi des équipements et les notifications Firebase FCM, le système a démontré sa capacité à automatiser la gestion des demandes de maintenance, à générer des alertes prioritaires et à s'adapter à différents types d'équipements.
\newline 
