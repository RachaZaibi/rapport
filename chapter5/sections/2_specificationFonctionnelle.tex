...
\input{chapter4/sections/subsection/2.1_useCaseDiagram.tex}

\subsection{Acteurs Principaux}
\input{chapter4/sections/subsection/2.2_acteurs.tex}

\subsection{Cas d'Utilisation}
\input{chapter4/sections/subsection/2.3_useCase.tex}