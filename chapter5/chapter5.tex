...
\begin{itemize}
    ...
    \item Une documentation complète, incluant le guide d’installation du pipeline, la documentation de l’API, et un rapport d’entraînement du modèle.
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Contrôles d’accès aux ressources matérielles} : Résolus par un calendrier partagé.
\end{enumerate}
