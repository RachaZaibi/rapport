...
Le diagramme de séquence ci-dessous illustre le flux de travail final du Sprint 4, intégrant les composants du Sprint 1 (collecte de données), du Sprint 2 (alertes et notifications), ainsi que les optimisations et améliorations apportées lors du Sprint 4. Ce flux complète le flux global (Figure~\ref{fig:global_sequence_diagram}).

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{chapter7/sprint_sequence_diagram.png}
    \caption{Diagramme de séquence du flux de travail final dans le Sprint 4.}
    \label{fig:sprint4_sequence_diagram}
\end{figure}

\section{Livrables}
Le Sprint 4 a permis de livrer :
\begin{itemize}
